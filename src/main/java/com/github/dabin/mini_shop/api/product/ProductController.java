...
public class ProductController {
    ...
    public CreateProductResponseDto create(@RequestBody CreateProductRequestDto createProductRequestDto) {
        return productApplicationService.save(createProductRequestDto);
    }
}
